...
int main()
{
	...
	unsigned char* image;
	// Diffuse map
	image = SOIL_load_image("res/images/container1.png", &width, &height, 0, SOIL_LOAD_RGB);
	...
	// Specular map
	image = SOIL_load_image("res/images/container1_specular.png", &width, &height, 0, SOIL_LOAD_RGB);
